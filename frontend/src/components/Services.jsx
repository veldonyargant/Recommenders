          ...
          {services.map((service, index) => (
            ...
            >
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-blue-100 to-green-100 rounded-xl flex items-center justify-center text-brand-blue group-hover:from-blue-200 group-hover:to-green-200 transition-all duration-300">
                ...
                <div className="border-t pt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      className="border-blue-200 text-brand-blue hover:bg-blue-50"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center lg:text-right">
              <div className="bg-white rounded-xl p-6 shadow-lg inline-block">
                ...
                <Button 
                  size="lg"
                  className="bg-brand-gradient hover:bg-brand-gradient text-white font-semibold hover:scale-105 transition-all duration-300"
                  onClick={scrollToContact}
                >
                  Obtenir mon devis
                </Button>
